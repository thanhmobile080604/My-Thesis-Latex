...
\texttt{LiveRoutingFragment} dùng vị trí GNSS làm nguồn chính để cập nhật marker trên tuyến đường. \texttt{LiveRoutingViewModel} đánh giá GNSS theo tuổi dữ liệu, số vệ tinh và độ chính xác. Khi GNSS không còn đủ tin cậy, hệ thống bật trạng thái assist, hiển thị panel camera và chạy KLT hoặc Farneback với độ nhạy cao để lấy metrics chuyển động ảnh.

Trong trạng thái assist, ViewModel dùng độ lớn Optical Flow đã làm mượt để ước lượng tốc độ tạm thời, dùng yaw rate từ IMU để cập nhật hướng và tích phân một bước dead reckoning ngắn hạn trên mặt đất. Kết quả được vẽ thành đoạn đường assist riêng để phân biệt với đoạn đường GNSS thật. Ứng dụng cũng có chế độ test GNSS dropout theo chu kỳ 10 giây; khi bật chế độ này, các đoạn đường GNSS thử nghiệm được vẽ bằng path riêng để người dùng quan sát lại sự khác biệt giữa đường GNSS và đường hỗ trợ bằng Optical Flow/IMU. Cách làm này không thay thế định vị chính xác, nhưng giúp mô phỏng một luồng hỗ trợ khi GNSS bị gián đoạn trong thời gian ngắn.
...
Live routing & Bắt đầu tuyến đường rồi mô phỏng GNSS yếu hoặc dropout. & Camera assist được bật; đường assist được vẽ riêng và tắt khi GNSS khả dụng trở lại. \\ \hline
