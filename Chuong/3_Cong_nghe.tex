...
OpenCV là thư viện thị giác máy tính mã nguồn mở được dùng làm nền tảng xử lý ảnh trong đồ án. Trên Android, OpenCV cung cấp kiểu dữ liệu \texttt{Mat} để biểu diễn ảnh và một tập hàm Optical Flow sẵn có như \texttt{goodFeaturesToTrack}, \texttt{calcOpticalFlowPyrLK} và \texttt{calcOpticalFlowFarneback}. Nhờ vậy, ứng dụng có thể tập trung vào việc thiết kế luồng xử lý và hiển thị thay vì hiện thực lại các thuật toán nền tảng.
