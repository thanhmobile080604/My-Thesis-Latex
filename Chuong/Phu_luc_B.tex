...
\textbf{Luồng chính} & Người dùng chọn điểm đến và bắt đầu live routing, ứng dụng cập nhật marker theo GNSS, theo dõi số vệ tinh và tuổi dữ liệu, bật camera assist khi GNSS không đủ tin cậy, dùng Optical Flow và IMU để cập nhật dead reckoning ngắn hạn, đồng thời vẽ path GNSS, path assist và path test dropout để quan sát lại. \\ \hline
\textbf{Luồng thay thế} & Nếu người dùng từ chối quyền camera, ứng dụng vẫn tiếp tục GNSS routing nhưng không bật assist camera. Nếu GNSS khả dụng trở lại, camera assist được tắt và marker quay về cập nhật theo GNSS. \\ \hline
...
\textbf{Luồng chính} & Người dùng chọn video, ứng dụng gửi multipart request hoặc upload theo chunk, server tạo job và xử lý background, ứng dụng thăm dò progress, tải file/chunk kết quả, gọi cleanup và mở trình phát video. \\ \hline
\textbf{Luồng thay thế} & Nếu server không sẵn sàng hoặc model lỗi, job chuyển sang failed và ứng dụng hiển thị thông báo. Nếu người dùng thoát màn hình, WorkManager foreground worker tiếp tục quản lý tiến độ. Nếu người dùng hủy, client hủy upload đang dở hoặc gửi yêu cầu hủy job. \\ \hline
